...
@push('url_title') Service List @endpush
@section('title')
@push('content')
    ...
    <div class="col-sm-12">
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                <h4 class="m-t-0 header-title"><b>Serives List</b></h4>
              </div>
                <div class="col-sm-8 text-right">
                <a class="btn btn-primary" href="{{ route('admin.services_1.create') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Service</a>
            </div><br><br>
            </div>
...
<script type="text/javascript">
     ...
     $('#product-datatable').dataTable({
        ...
        "serverSide": true,
         "columns": [
            ...
            { "title": "Sub Title", "data": "sub_title", "sub_title": "sub_title",},
            ...
            { "title": "Status", "data": "status", "name": "status", searchable: false, sortable: false,},
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.services_1.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.services_1') }}",
              data: { "_token": "{{ csrf_token() }}" , id: services_id, status:status },
