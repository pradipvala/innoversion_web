        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.brand') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Brand</a>
            </div><br><br>
            </div>
                 ...
                 <div class="row">
                     <div class="col-sm-12">
                         <div class="table-responsive">
                             <table id="brand-datatable" class="table table-striped table-bordered">
...
<script type="text/javascript">
     ...
     $('#brand-datatable').dataTable({
        ...
        "serverSide": true,
         "columns": [
            ...
            { "title": "Company Name", "data": "name", "name":"name"},
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.brands.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.brand') }}",
              data: { "_token": "{{ csrf_token() }}" , id: brand_id, status:status },
