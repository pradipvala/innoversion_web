                ...
                <div class="card-box table-responsive">
                    <div class="m-t-0 m-b-10 row">
                        ...
                        <div class="col-sm-8 text-right">
                            <a class="btn btn-primary" href="{{ route('admin.create.project') }}" role="button"> <span><i
                                        class="fa fa-plus"></i></span> Add Project</a>
                        </div><br><br>
                    </div>
    ...
    @push('js')
        <script type="text/javascript">
            $('#project-datatable').dataTable({
                ...
                "responsive": false,
                "ajax": {
                    "url": "{{ route('admin.projects.listing') }}", // ajax source
                },
            });
            ...
            $(document).on('click', '#status', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.change.status.project') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id: project_id,
                        status: status
