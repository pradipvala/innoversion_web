...
@push('url_title') Team Members @endpush
@section('title')
@push('content')
        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.member') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Member</a>
            </div><br><br>
            </div>
...
<script type="text/javascript">
     ...
     $('#member-datatable').dataTable({
        ...
        "serverSide": true,
         "columns": [
            ...
            { "title": "Role", "data": "role", "name": "role", sortable: true,},
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.members.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.member') }}",
              data: { "_token": "{{ csrf_token() }}" , id: member_id, status:status },
