...
@push('url_title') Gallery @endpush
@section('title')
@push('content')
        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.gallery') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Gallery</a>
            </div><br><br>
            </div>
                 ...
                 <div class="row">
                     <div class="col-sm-12">
                         <div class="table-responsive">
                             <table id="gallery-datatable" class="table table-striped table-bordered">
...
<script type="text/javascript">
     ...
     $('#gallery-datatable').dataTable({
        ...
        "serverSide": true,
         "columns": [
            ...
            { "title": "Title", "data": "title", "name": "title", sortable: true,},
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.galleries.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.gallery') }}",
              data: { "_token": "{{ csrf_token() }}" , id: gallery_id, status:status },
