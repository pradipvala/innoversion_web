    ...
    <div class="col-sm-12">
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                <h4 class="m-t-0 header-title"><b>Blogs</b></h4>
              </div>
                <div class="col-sm-8 text-right">
                <a class="btn btn-primary" href="{{ route('admin.create.blog') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Blog</a>
            </div><br><br>
            </div>
...
<script type="text/javascript">
     ...
     $('#blog-datatable').dataTable({
        ...
        "serverSide": true,
         "columns": [
            ...
            { "title": "blog_long_description", "data": "blog_long_description", "name": "blog_long_description", sortable: true,},
            { "title": "category", "data": "category", "name": "category", sortable: true,},
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.blogs.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.blog') }}",
