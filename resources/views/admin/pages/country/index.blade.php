...
@push('title') Country Master @endpush
  ...
  <div class="col-sm-12">
      <div class="card-box table-responsive">
          <div class="m-t-0 m-b-10 row">
            <div class="col-sm-4">
              <h4 class="m-t-0 header-title"><b>Country Management</b></h4>
            </div>
              <div class="col-sm-8 text-right">
                
                  <a class="btn btn-primary" href="{{ route('admin.country.create') }}" role="button"> <span><i class="fa fa-plus"></i></span> Create New Country</a>
