...
@push('url_title') Categories @endpush
        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.category',['id' => '0']) }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Category</a>
            </div><br><br>
            </div>
...
<script type="text/javascript">
     ...
     $('#category-datatable').dataTable({
        ...
        "columns": [
            ...
            { "title": "Action", "data": "action", sortable:false ,width: '10%'},
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.categories.listing',['id' => '0']) }}", // ajax source    
        },
     });
