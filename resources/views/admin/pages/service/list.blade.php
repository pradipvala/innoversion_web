        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.service') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Service</a>
            </div><br><br>
            </div>
                 ...
                 <div class="row">
                     <div class="col-sm-12">
                         <div class="table-responsive">
                             <table id="service-datatable" class="table table-striped table-bordered">
...
<script type="text/javascript">
     ...
     $('#service-datatable').dataTable({
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.services.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.service') }}",
              data: { "_token": "{{ csrf_token() }}" , id: service_id, status:status },
