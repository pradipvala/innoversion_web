      ...
      <div class="col-md-12">
        <div class="card-box">
            <div class="row form-horizontal">
              <form class="form-horizontal" id="franchise-form" role="form" method="POST" action="{{ route('admin.save.franchise') }}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="form-select form-control select2" aria-label="Default select example" name="c_name" id="city_id" value="">
                      ...
                      <div class="col-sm-3">
                        ...
                        <input type="file"class="filestyle"   name="aadhaar_img" id="aadhaar_img" 
                          class="form-control" accept="image/jpg, image/png, image/gif, image/jpeg"/>
                      </div>
