...
@push('url_title') Franchise Details  @endpush
          ...
          <div class="row form-horizontal">
            ...
            <div class="form-group">
              <div class="col-sm-3">
                ...
                {{ isset($franchise->business_name) &&!empty($franchise->business_name)?$franchise->business_name:NULL;}}
              </div>

              <div class="col-sm-3">
                <label><b>Franchise name</b> :- </label>
                  {{ isset($franchise->franchise_name) &&!empty($franchise->franchise_name)?$franchise->franchise_name:NULL;}}
              </div>

              <div class="col-sm-3">
                <label><b>Gst no.</b> :- </label>
                  {{ isset($franchise->gst_no) &&!empty($franchise->gst_no)?$franchise->gst_no:NULL;}}
              </div>

              <div class="col-sm-3">
                <label><b>Contact No.</b> :- </label>
                  {{ isset($franchise->contact_no) &&!empty($franchise->contact_no)?$franchise->contact_no:NULL;}}
              </div>
            
              <div class="col-sm-3">
                <label><b>Email Address</b> :- </label>
                  {{ isset($franchise->email) &&!empty($franchise->email)?$franchise->email:NULL;}}
              </div>
              ...
              <div class="col-sm-3">
                <label><b>Contact Person Name</b> :- </label>
                    {{ isset($franchise->contact_person) &&!empty($franchise->contact_person)?$franchise->contact_person:NULL;}}
              </div>

              <div class="col-sm-3">
                <label><b>Pan Card no.</b> :- </label>
                    {{ isset($franchise->pan_no) &&!empty($franchise->pan_no)?$franchise->pan_no:NULL;}}
              </div>

              <div class="col-sm-3">
                <label><b>Aadhaar Card No.</b> :- </label>
                  {{ isset($franchise->aadhaar_no) &&!empty($franchise->aadhaar_no)?$franchise->aadhaar_no:NULL;}}
              </div>
              ...
              <div class="col-sm-3">
                <div class="approval_status_div" id="approval_status_div" >
                  <?php 
                  ...
                  ?>
                    ...
                    @if($franchise->approval_status =='Rejected')
