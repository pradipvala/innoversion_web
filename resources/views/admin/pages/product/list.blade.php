        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.product') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Product</a>
            </div><br><br>
            </div>
     ...
     $('#product-datatable').dataTable({
        ...
        "serverSide": true,
         "columns": [
            ...
            {"title":  "Brand", "data": "brands",  searchable: false, sortable: false,width: '10%'}
        ],
