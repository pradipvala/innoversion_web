            ...
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <div class="col-sm-8 text-right">
                    <a class="btn btn-primary" href="{{ route('admin.create.aboutus') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add About Us</a>
                </div><br><br>
            </div>
...
<script type="text/javascript">
     ...
     $('#about-datatable').dataTable({
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.aboutus.listing') }}", // ajax source    
        },        
     });
