...
@push('url_title')
    Home Page product Edit
@endpush

@section('title', 'Add Product Home page')
                ...
                <div class="card-box">
                    <div class="row form-horizontal">
                        <form class="form-horizontal" id="aboutus-form" role="form" method="POST"
                            action="{{ route('admin.update.homepageproduct', ['id' => $homepageproduct->id]) }}"
                            ...
                            <div class="form-group">
                                <div class="col-sm-10">
                                    ...
                                    <textarea id="description" name="description" style="width: 59%;" class="form-control">{{ $homepageproduct->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    ...
                                    @if (isset($homepageproduct->image))
                                        <img src="{{ \Storage::url($homepageproduct->image) }}" height="80px"
                                            width="80px"><br /><br />
                            ...
                            @if(count($homepageproduct->productpoints) == 0)
                            
                            <div class="form-group" id="points-container">
                                <div class="col-sm-6 point-input">
                                    <label>Points :- </label>
                            ...
                            @else
                            <div class="form-group" id="points-container">
                                @foreach ($homepageproduct->productpoints as $productpoint)
                                    <div class="col-sm-6 point-input">
                                        <label>Points :- </label>
                                        <input type="text" name="point[]" value="{{ $productpoint->title }}"
                                            class="form-control" />
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-lg-10">
                                    ...
                                    <a href="{{ route('admin.aboutus') }}"><button type="button"
