                ...
                <div class="card-box">
                    <div class="row form-horizontal">
                        <form class="form-horizontal" id="aboutus-form" role="form" method="POST"
                            action="{{ route('admin.save.homepageproduct') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-sm-10">
                                    ...
                                    <textarea id="description" name="description" style="width: 59%;" class="form-control"></textarea>
                                </div>
                            </div>
