...
@push('url_title') Role Details @endpush
@section('title')
  ...
  <div class="col-sm-12">
      <div class="card-box table-responsive">
          <div class="m-t-0 m-b-10 row">
            <div class="col-sm-4">
              <h4 class="m-t-0 header-title"><b>Role Management</b></h4>
            </div>
              <div class="col-sm-8 text-right">
                {{-- @can('role-create')  --}}
                  <a class="btn btn-primary" href="{{ route('admin.roles.create') }}" role="button"> <span><i class="fa fa-plus"></i></span>  Create New Role</a>
                  {{-- @endcan --}}
              </div><br><br>
          </div>
