...
@push('url_title') Testimonials @endpush
@section('title')
@push('content')
        ...
        <div class="card-box table-responsive">
            <div class="m-t-0 m-b-10 row">
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary" href="{{ route('admin.create.testimonial') }}" role="button"> <span><i class="fa fa-plus"></i></span> Add Testimonial</a>
            </div><br><br>
            </div>
                 ...
                 <div class="row">
                     <div class="col-sm-12">
                         <div class="table-responsive">
                             <table id="testimonial-datatable" class="table table-striped table-bordered">
...
<script type="text/javascript">
     ...
     $('#testimonial-datatable').dataTable({
        ...
        "responsive": false,
        "ajax": {
            "url": "{{ route('admin.testimonials.listing') }}", // ajax source    
        },        
     });
     ...
     $(document).on('click','#status',function(){
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.change.status.testimonial') }}",
