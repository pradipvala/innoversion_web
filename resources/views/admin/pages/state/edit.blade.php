            ...
            <div class="col-md-12">
                <div class="card-box">
                    <div class="row form-horizontal">
                        <form class="form-horizontal" id="aboutus-form" role="form" method="POST" action="{{ route('admin.state.update') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" name="state" id="state" class="form-control" placeholder="Enter State Name"  value="{{$data->state}}" required>
                                </div>
