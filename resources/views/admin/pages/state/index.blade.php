...
@push('url_title') State Master @endpush
  ...
  <div class="col-sm-12">
      <div class="card-box table-responsive">
          <div class="m-t-0 m-b-10 row">
            <div class="col-sm-4">
              <h4 class="m-t-0 header-title"><b>State Management</b></h4>
            </div>
              <div class="col-sm-8 text-right">
                
                  <a class="btn btn-primary" href="{{ route('admin.state.create') }}" role="button"> <span><i class="fa fa-plus"></i></span> Create New State</a>
