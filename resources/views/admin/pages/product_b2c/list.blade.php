                ...
                <div class="card-box table-responsive">
                    <div class="m-t-0 m-b-10 row">
                        ...
                        <div class="col-sm-8 text-right">
                            <a class="btn btn-primary" href="{{ route('admin.create.product') }}" role="button"> <span><i
                                        class="fa fa-plus"></i></span> Add Product</a>
                        </div><br><br>
                    </div>
    ...
    @push('js')
        <script type="text/javascript">
            $('#product-datatable').dataTable({
                ...
                "responsive": false,
                "ajax": {
                    "url": "{{ route('admin.products.b2c.listing') }}", // ajax source
                },
            });
