            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <div class="m-t-0 m-b-10 row">
                        <div class="col-sm-4">
                            <h4 class="m-t-0 header-title"><b>Contact File</b></h4>
                        </div>
                        <div class="col-sm-8 text-right">
                            <a class="btn btn-primary" href="{{ route('admin.contact.file.edit', ['id' => $file->id]) }}"
                                role="button"> <span><i class="fa fa-plus"></i></span>Edit Contact File</a>
                        </div><br><br>
                    </div>
                                    ...
                                    <table id="product-datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ \Storage::url($file->file) }}">File</a>
                                                </td>
                                            </tr>
