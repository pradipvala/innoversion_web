                            ...
                            <div class="widget-bg-color-icon card-box fadeInDown animated">
                                <center>
                                    @if(isset($product->product_image) && !empty($product->product_image))
                                       ...
                                       <img src="{{  \Storage::url($product->product_image[0]->image) }}" width="120" height="120"><br /><br />
                                    @else
                                    ...
                                    <div class="">
                                        <a href="{{ url('admin/view_products', $product->id) }} " class="btn btn-primary waves-effect waves-light">View More</a>
                                    </div>
                                </center>
                            </div>
                        </div>
