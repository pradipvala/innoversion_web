                ...
                <div class="newsletter-wrapper">
                    <div class="newsletter-layout">
                        ...
                        <div class="d-flex flex-column gspace-5 position-relative z-2">
                            ...
                            <form action="{{ route('newsletter.subscribe') }}" method="POST" id="newsletterForm" class="needs-validation animate-box animated animate__animated" data-animate="animate__fadeInRight">
                                @csrf
                                <div class="input-container">
                                    <input type="email" name="email" id="newsletter-email" placeholder="Give your best email" value="{{ old('email') }}" required>
