            ...
            <div class="banner-layout-wrapper">
                <div class="banner-layout">
                    <div class="d-flex flex-column text-center align-items-center gspace-2">
                        <h2 class="title-heading animate-box animated animate__animated" data-animate="animate__fadeInRight">{{ $industry['name'] }}</h2>
            ...
            <div class="hero-container">
                <div class="d-flex flex-column gspace-5">
                    <div class="image-container">
                        <img src="{{ asset('image/dummy-img-600x400.jpg') }}" alt="{{ $industry['name'] }} Banner" class="single-service-img" style="object-fit: cover;">
                            ...
                            <div class="">
                                ...
                                <div class="single-service-title-wrapper">
                                    <div class="single-service-title">
                                        ...
                                        <h3 class="title-heading animate-box animated animate__animated" data-animate="animate__fadeInRight">Empowering {{ $industry['name'] }} With Technology</h3>
                            ...
                            <div class="d-flex flex-column flex-md-row flex-xl-column justify-content-between gspace-5">
                                <div class="card service-recent">
                                    ...
                                    <ul class="single-service-list">
                                        ...
                                        <li><a href="{{ route('industry.details', 'finance-banking') }}">Finance & Banking</a></li>
                                        <li><a href="{{ route('industry.details', 'manufacturing') }}">Manufacturing</a></li>
                                        <li><a href="{{ route('industry.details', 'retail-ecommerce') }}">Retail & E-commerce</a></li>
                                ...
                                <div class="cta-service-banner">
                                    ...
                                    <p>
                                        Leverage our deep industry expertise and innovative digital solutions to accelerate your organizational growth securely.
                                    </p>
