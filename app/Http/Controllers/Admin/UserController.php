...
class UserController extends Controller
{
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    ...
                    //if (auth()->user()->can('user-view')) {
                        $return .=  '<a href="'.route('admin.users.view', ['id' => base64_encode($data->id)]).'" class="btn btn-default btn-xs">
                                            <i class="fa fa-eye"></i>
                                        </a> &nbsp;';
                    //}

                    //if (auth()->user()->can('user-edit')) {
                        $return .= '<a href="'.route('admin.users.edit', ['id' => base64_encode($data->id)]).'" class="btn btn-default btn-xs">
    ...
    {   
        ...
        if(isset($id) && $id != '' && $id != null){
            ...
            return redirect()->route('admin.user')->with('error', 'Something went wrong');
        }
        $role = Role::all();       
        $user = User::find($id);
        
        return view('admin.pages.users.show',compact('user','role'));
    }
    /** show */
    ...
    {  
        ...
        return view('admin.pages.users.edit',compact('user','roles','userRole','userRolename'));
    }
    /** edit */
