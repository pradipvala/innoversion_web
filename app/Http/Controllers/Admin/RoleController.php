...
class RoleController extends Controller 
{
            ...
            $data = Role::orderBy('id', 'DESC')->get();
                ...
                return DataTables::of($data)
                    ...
                    ->addColumn('action', function($data){
                        ...
                        //if(auth()->user()->can('role-view')){
                            $return .= '<a href="'.route('admin.roles.view', ['id' => base64_encode($data->id)]).'" class="btn btn-default btn-xs">
                                            <i class="fa fa-eye"></i>
                                        </a> &nbsp;';
                      // }

                        // if(auth()->user()->can('role-edit')){
                            $return .= '<a href="'.route('admin.roles.edit', ['id' => base64_encode($data->id)]).'" class="btn btn-default btn-xs">
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('admin.pages.roles.show', compact('role', 'permissions', 'rolePermissions'));
    }
