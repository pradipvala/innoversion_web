...
class HomePageProductController extends Controller
{
    ...
    {
        return view('admin.pages.homepageproduct.index');
    }
        ...
        foreach ($aboutusdata as $key => $aboutus) {
            ...
            $records['data'][] = [
                ...
                'action' => view('admin.shared.action')
                    ->with(['id' => $aboutus->id, 'routeName' => 'admin.homepageproduct', 'view' => false])
                    ->render(),
            ];
        }
        return $records;
    ...
    {
        return view('admin.pages.homepageproduct.create');
    }
    ...
    public function save(Request $request)
    {
       ...
       $homepageproduct->description = $request->input('description');
        ...
        if ($request->hasFile('image')) {
           ...
           $imagepath = 'homepageproduct/' . str_replace(' ', '-', $request->file('image')->getClientOriginalName());
       ...
       foreach($request->input('point') as $point)
       {
        ...
        return redirect()->route('admin.create.homepageproduct');

    }

    public function edit(HomePageProduct $id)
    {
        return view('admin.pages.homepageproduct.edit')->with(['homepageproduct'=>$id]);
    }
    ...
    public function update(HomePageProduct $id,Request $request)
    {
        ...
        //  return redirect()->route('admin.create.homepageproduct');
         return redirect()->route('admin.homepageproduct');
