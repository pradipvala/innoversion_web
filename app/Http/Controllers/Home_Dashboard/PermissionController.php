...
/** construct */
    ...
    /** insert */
        public function store(Request $request){
            ...
            if($last_id > 0){
                return redirect()->route('permission')->with('success', 'Permission Record inserted successfully');
            }else{
    ...
    /** update */
        public function update(Request $request){
            ...
            if($update)
                return redirect()->route('permission')->with('success', 'Permission Record updated successfully');
            else
