...
class FranchiseController extends Controller
{
    ...
    public function all()
    {
        ...
        return view('frontend.franchise.franchise_list',compact('franchise'));
    }
    ...
    {
        return view('frontend.franchise.franchise_add');
    }
    ...
    public function save_franchise(REQUEST $request)
    {
        ...
        if ($request->hasFile('aadhaar_img')) {
         ...
         return redirect()->route('franchise')->with('success', 'Franchise details added successfully');
    ...
    public function listing(Request $request)
    {
        ...
        $franchise = Franchise::where('deleted_at', '=' , null)->orderBy('created_at', 'DESC');
        ...
        foreach ($franchise as $key => $fran) {
                ...
                $records['data'][] = [
                    ...
                    'status' => view('frontend.shared.action', ['statusshow' => true, 'id' => $fran->id, 'routeName' => 'franchise', 'status' => $fran->status, 'view' => false, 'edit' => false, 'delete' => false])->render(),
                    'action' => view('frontend.shared.action')
                    ->with(['id' => $fran->id, 'routeName' => 'franchise', 'view' => false, 'franchise_code' => true])
                    ->render(),
                ];
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('franchise')->with('success', 'Franchise details Deleted successfully');
    ...
    public function edit(Request $request,$id)
    {
        ...
        // dd($franchise);
        return view('frontend.franchise.franchise_edit', compact('franchise'));
    }
    ...
    public function update(Request $request)
    {
       ...
       $update= [
        ...
        return redirect()->route('franchise')->with('success', 'Franchise details updated successfully');
    ...
    public function generate_franchise_code(Request $request,$id)
    {
       ...
       $franchise_link= Franchise::where('id', $id)->update(['franchise_code'=>$generate_franchise_code]);
        ...
        if($franchise_link){
            ...
            return redirect()->route('franchise')->with('failed', "Failed to update Franchise details");
        }
